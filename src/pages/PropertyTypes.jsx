  ...
  return (
    <div className="property-types-container">
      ...
      <div className="property-types-content">
        <h1 className="property-types-title">Host and experience </h1>
        <p className="property-types-subtitle">Share your property or vehicles with Travelers around the world</p>
